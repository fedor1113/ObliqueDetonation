...
parser.add_argument('-k', type=float, default=35.955584760859722, help='rate constant')
parser.add_argument('-L', type=float, default=10, help='integration length')
parser.add_argument('-t', '--tol', type=float, default=1e-12, help='solver tolerance')
